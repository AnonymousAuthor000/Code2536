...
TfLiteRegistration* Register_qryjse_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, qryjse::Prepare,
      qryjse::Eval<qryjse::kReference>};
  return &r;
}

TfLiteRegistration* Register_qryjse_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, qryjse::Prepare,
      qryjse::Eval<qryjse::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_qryjse() {
  // TODO(ahentz): It turns out the two versions of qryjse are almost
  // identical, so we should consider removing one.
  return Register_qryjse_GENERIC_OPT();
}
