...
const TfLitePadding paddings=kTfLitePaddingValid;
const int stride_height=1;
const int stride_width=1;
const int filter_height=13;
const int filter_width=13;
...
TfLiteRegistration* Register_xzyluz_REF() {
  static TfLiteRegistration r = {xzyluz::Init, xzyluz::Free,
                                 xzyluz::GenericPrepare<xzyluz::kAverage>,
                                 xzyluz::AverageEval<xzyluz::kReference>};
  return &r;
}
...
TfLiteRegistration* Register_xzyluz_GENERIC_OPT() {
  static TfLiteRegistration r = {
      xzyluz::Init, xzyluz::Free, xzyluz::GenericPrepare<xzyluz::kAverage>,
      xzyluz::AverageEval<xzyluz::kGenericOptimized>};
  return &r;
}
...
TfLiteRegistration* Register_xzyluz() {
  return Register_xzyluz_GENERIC_OPT();
}
