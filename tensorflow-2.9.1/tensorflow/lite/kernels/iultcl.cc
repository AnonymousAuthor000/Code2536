...
TfLiteRegistration* Register_iultcl_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, iultcl::Prepare,
      iultcl::Eval<iultcl::kReference>};
  return &r;
}

TfLiteRegistration* Register_iultcl_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, iultcl::Prepare,
      iultcl::Eval<iultcl::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_iultcl() {
  // TODO(ahentz): It turns out the two versions of iultcl are almost
  // identical, so we should consider removing one.
  return Register_iultcl_GENERIC_OPT();
}
