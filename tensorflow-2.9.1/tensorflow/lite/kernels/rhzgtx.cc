...
// TfLiteRegistration* Register_rhzgtx_REF() {
...
TfLiteRegistration* Register_rhzgtx_REF() {
  static TfLiteRegistration r = {rhzgtx::Init, rhzgtx::Free,
                                 rhzgtx::GenericPrepare<rhzgtx::kMax>,
                                 rhzgtx::MaxEval<rhzgtx::kReference>};
  return &r;
}
...
// TfLiteRegistration* Register_rhzgtx_GENERIC_OPT() {
...
TfLiteRegistration* Register_rhzgtx_GENERIC_OPT() {
  static TfLiteRegistration r = {rhzgtx::Init, rhzgtx::Free,
                                 rhzgtx::GenericPrepare<rhzgtx::kMax>,
                                 rhzgtx::MaxEval<rhzgtx::kGenericOptimized>};
  return &r;
}
...
//   return Register_rhzgtx_GENERIC_OPT();
// }
