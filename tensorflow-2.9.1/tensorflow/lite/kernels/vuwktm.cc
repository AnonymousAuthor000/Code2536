...
TfLiteRegistration* Register_vuwktm_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, vuwktm::Prepare,
      vuwktm::Eval<vuwktm::kReference>};
  return &r;
}

TfLiteRegistration* Register_vuwktm_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, vuwktm::Prepare,
      vuwktm::Eval<vuwktm::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_vuwktm() {
  // TODO(ahentz): It turns out the two versions of vuwktm are almost
  // identical, so we should consider removing one.
  return Register_vuwktm_GENERIC_OPT();
}
