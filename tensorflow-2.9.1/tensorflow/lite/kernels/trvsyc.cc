...
TfLiteRegistration* Register_trvsyc_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, trvsyc::Prepare,
      trvsyc::Eval<trvsyc::kReference>};
  return &r;
}

TfLiteRegistration* Register_trvsyc_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, trvsyc::Prepare,
      trvsyc::Eval<trvsyc::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_trvsyc() {
  // TODO(ahentz): It turns out the two versions of trvsyc are almost
  // identical, so we should consider removing one.
  return Register_trvsyc_GENERIC_OPT();
}
