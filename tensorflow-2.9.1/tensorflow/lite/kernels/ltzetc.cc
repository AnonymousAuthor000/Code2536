...
TfLiteRegistration* Register_ltzetc_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, ltzetc::Prepare,
      ltzetc::Eval<ltzetc::kReference>};
  return &r;
}

TfLiteRegistration* Register_ltzetc_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, ltzetc::Prepare,
      ltzetc::Eval<ltzetc::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_ltzetc() {
  // TODO(ahentz): It turns out the two versions of ltzetc are almost
  // identical, so we should consider removing one.
  return Register_ltzetc_GENERIC_OPT();
}
