...
TfLiteRegistration* Register_zzdthb_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, zzdthb::Prepare,
      zzdthb::Eval<zzdthb::kReference>};
  return &r;
}

TfLiteRegistration* Register_zzdthb_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, zzdthb::Prepare,
      zzdthb::Eval<zzdthb::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_zzdthb() {
  // TODO(ahentz): It turns out the two versions of zzdthb are almost
  // identical, so we should consider removing one.
  return Register_zzdthb_GENERIC_OPT();
}
