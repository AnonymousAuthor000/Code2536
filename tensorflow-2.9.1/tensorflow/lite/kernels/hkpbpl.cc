...
TfLiteRegistration* Register_hkpbpl_REF() {
  static TfLiteRegistration r = {
      nullptr, nullptr, hkpbpl::Prepare,
      hkpbpl::Eval<hkpbpl::kReference>};
  return &r;
}

TfLiteRegistration* Register_hkpbpl_GENERIC_OPT() {
  static TfLiteRegistration r = {
      nullptr, nullptr, hkpbpl::Prepare,
      hkpbpl::Eval<hkpbpl::kGenericOptimized>};
  return &r;
}

TfLiteRegistration* Register_hkpbpl() {
  // TODO(ahentz): It turns out the two versions of hkpbpl are almost
  // identical, so we should consider removing one.
  return Register_hkpbpl_GENERIC_OPT();
}
