...
TfLiteRegistration* Register_jnksmt_REF() {
  static TfLiteRegistration r = {
      jnksmt::SoftmaxInit, jnksmt::SoftmaxFree,
      jnksmt::SoftmaxPrepare<jnksmt::kReference>,
      jnksmt::SoftmaxEval<jnksmt::kReference>};
  return &r;
}
...
TfLiteRegistration* Register_jnksmt() {
  static TfLiteRegistration r = {
      jnksmt::SoftmaxInit, jnksmt::SoftmaxFree,
      jnksmt::SoftmaxPrepare<jnksmt::kGenericOptimized>,
      jnksmt::SoftmaxEval<jnksmt::kGenericOptimized>};
  return &r;
}
