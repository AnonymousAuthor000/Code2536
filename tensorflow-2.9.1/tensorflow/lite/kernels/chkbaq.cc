...
// TfLiteRegistration* Register_chkbaq_REF() {
...
TfLiteRegistration* Register_chkbaq_REF() {
  static TfLiteRegistration r = {chkbaq::Init, chkbaq::Free,
                                 chkbaq::GenericPrepare<chkbaq::kMax>,
                                 chkbaq::MaxEval<chkbaq::kReference>};
  return &r;
}
...
// TfLiteRegistration* Register_chkbaq_GENERIC_OPT() {
...
TfLiteRegistration* Register_chkbaq_GENERIC_OPT() {
  static TfLiteRegistration r = {chkbaq::Init, chkbaq::Free,
                                 chkbaq::GenericPrepare<chkbaq::kMax>,
                                 chkbaq::MaxEval<chkbaq::kGenericOptimized>};
  return &r;
}
...
//   return Register_chkbaq_GENERIC_OPT();
// }
